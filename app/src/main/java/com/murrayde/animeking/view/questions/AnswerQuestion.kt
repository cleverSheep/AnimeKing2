    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        QuestionFactory.RETRIEVE(attributes.titles.en
            ...
            override fun onStatusCallback(list: ArrayList<Question>) {
                ...
                loadQuestions(questions, 0, view, listButtons())
            }
        })
    }

    // TODO: WRITE TEST FOR loadQuestions(...)
    private fun loadQuestions(questions: ArrayList<Question>, track: Int, view: View, list_buttons: ArrayList<Button>) {
        ...
        buttonChoiceClick(list_buttons, questions, track)
        ...
        button_next_question.setOnClickListener {
            ...
            loadQuestions(questions, ++question_track, view, list_buttons)
        }

    }

    private fun buttonChoiceClick(list_buttons: ArrayList<Button>, questions: ArrayList<Question>, question_track: Int) {
        val correct_response = questions[question_track].multiple_choice[0]
